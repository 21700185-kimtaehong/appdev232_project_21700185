...
//fighter common
List<Action> fighter_level1_action = [Action(actionName: '재기의 바람')];
List<Action> fighter_level2_action = [Action(actionName: "행동 연쇄")];
...
List<Action> battleMaster_manoeuvres = [
  Action(
      actionName: '지휘관의 일격',
      actionDescription:
